...
export const POLICY_URL = 'https://edu.repchess.ru/policy'
export const OFFER_URL = 'https://edu.repchess.ru/offer'
...
export const BUY_LINKS: [string, string][] = [
  ['Выбрать пакет на сайте', 'https://edu.repchess.ru?utm_source=telegram&utm_medium=bot_cabinet&utm_campaign=buy'],
]
