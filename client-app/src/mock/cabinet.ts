...
export const MOCK_CABINET: Cabinet = {
  ...
  // Формат полей — как у бота (fmtItem): дата dd.MM.yyyy, тип «Индив. · офлайн»,
  // заметка тренера многострочная (он пишет списками).
  upcoming: [
    {
      id: 'u1', date: '09.09.2026', time: '16:00', type: 'Индив. · офлайн',
      trainerName: 'Кабардикова Малика Алимовна', cancellable: true,
      notes: 'Элементы стратегии эндшпиля:\n• Централизация короля, легких фигур и ферзя;\n• Убежище и постройка мостов',
    },
    { id: 'u2', date: '11.09.2026', time: '18:00', type: 'Групповое · онлайн', trainerName: 'Пивоваров Тимофей Алексеевич' },
  ],
  ...
  lessonHistory: [
    {
      id: 'h1', date: '02.08.2026', time: '16:00', type: 'Индив. · офлайн', status: 'done',
      trainerName: 'Кабардикова Малика Алимовна',
      notes: 'Элементы стратегии эндшпиля:\n• Централизация короля, легких фигур и ферзя;\n• Убежище и постройка мостов',
    },
    { id: 'h2', date: '30.07.2026', time: '18:00', type: 'Групповое · онлайн', status: 'done', trainerName: 'Пивоваров Тимофей Алексеевич' },
    { id: 'h3', date: '26.07.2026', time: '16:00', type: 'Индив. · офлайн', status: 'absent', trainerName: 'Кабардикова Малика Алимовна' },
  ],
